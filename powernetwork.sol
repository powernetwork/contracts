...
/*
    ...
    1. 15 minute high tax period at listing
    2. 30% of supply sent to burn
    3. 5% of supply sent to burn address x4

*/ 



contract POWERNETWORK is Context, IERC20, Ownable {
    ...
    string private _name = "POWERNETWORK.IO";
    string private _symbol = "POWER";
    ...
    uint256 public _maxTxAmount = 150 * 10**6 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 250 * 10**2 * 10**9;
